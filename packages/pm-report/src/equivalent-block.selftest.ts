...
import { buildEquivalentBlockWorkbook, equivalentBlockWorkbookFileName } from './equivalent-block'
 ...
 * archived under `docs/example case`; the rest exercise topology and are not kept.
 */
const CASES = [
  {
    file: 'docs/example case/PM-advanced (7) 2D.pm-project.json',
    rebindTo: 'kds-142020-equivalent-block' as const,
    thetaDeg: 15,
    archive: true
  },
  { file: 'docs/example/ACI-EB-01-rectangle-8-bars.pm-project.json', rebindTo: null, thetaDeg: 0, archive: false },
  { file: 'docs/example/KDS-EB-02-hollow-8-bars.pm-project.json', rebindTo: null, thetaDeg: 30, archive: false },
  { file: 'docs/example/ACI-EB-03-l-shape-8-bars.pm-project.json', rebindTo: null, thetaDeg: 45, archive: false }
] as const
