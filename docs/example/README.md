...
`packages/pm-analysis-equivalent-block/src/integration.test.ts` parses all eight files, rebuilds
...
```powershell
npm.cmd exec -- tsx tools/generate-equivalent-block-examples.ts
```
