...
| Preview beta/angle grid for 3D surface | `apps/web/lib/pm-preview-analysis.ts` `buildPreviewSurface` | [`05-pm-diagram-19points-angles-plotting.md`](05-pm-diagram-19points-angles-plotting.md) | preview only |
