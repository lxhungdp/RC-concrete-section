...
| Stress-strain 36-direction seed and 0.5% adaptive refinement | `packages/pm-project/src/analysis-options.ts` | [`05-pm-diagram-stations-angles-plotting.md`](05-pm-diagram-stations-angles-plotting.md) | implemented preview; not a demand-moment angle |
| Equivalent-block shared 22-state/24-direction defaults | `packages/pm-project/src/analysis-options.ts` | [`12-calculation-models-defaults-and-workflows.md`](12-calculation-models-defaults-and-workflows.md) | implemented preview |
