...
| Results chart presentation state (angles, visibility, resistance stage) | `apps/web/features/section-editor/results/results-view.ts` | [`05-pm-diagram-19points-angles-plotting.md`](05-pm-diagram-19points-angles-plotting.md) | preview presentation; nothing here changes a resultant |
