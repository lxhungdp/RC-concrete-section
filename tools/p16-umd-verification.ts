 ...
 *
 * Source report: `docs/example case/P16_Column_ULS_R _260730_콘크리트 커브 추가수정.md`
 ...
 *
 * Run: npx tsx tools/p16-umd-verification.ts
 */
...
const SOURCE = resolve(ROOT, 'docs/example case/P16_Column_ULS_R _260730_콘크리트 커브 추가수정.md')
const PROJECT_OUT = resolve(ROOT, 'docs/example case/P16_Column_ULS.pm-project.json')
const RESULT_OUT = resolve(ROOT, 'docs/example case/P16_umd-vs-engine.json')
...
const result = {
  meta: {
    source: 'docs/example case/P16_Column_ULS_R _260730_콘크리트 커브 추가수정.md',
    projectInput: 'docs/example case/P16_Column_ULS.pm-project.json',
